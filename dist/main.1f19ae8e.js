...
var html = document.querySelector("#html"); //首先我们来获取 index.html 里的 demo 。
...
var string2 = ""; //为了完成 1 对 4 ，要再声明一个字符串。

var n = -1; //要找一个东西来记住当前是第几行。
...
var step = function step() {
  setTimeout(function () {
    ...
    if (n < string.length - 1) {
      step();
    } else {} //如果 n 小于等于 10 ，我就 step ，否则什么都不做。
